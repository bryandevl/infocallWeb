...
@section('htmlheader_title')
    Operadores | Cargar Números de Whatsapp
@endsection
@section('contentheader_breadcrumb')
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Cargar Números de Whatsapp</li>
    </ol>
@endsection
...
<script type="text/javascript" src="{{ asset('/js/operadores/uploadPhoneWhatsapp.js') }}?v=202108070344"></script>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 pull-right">
                                ...
                                <a href="{{ route('operador.upload_phone_whatsapp.download_template') }}" style="color: black; text-align: right; text-decoration: underline;">Descargar Plantilla para Carga</a>
                        </div>
                    </div>
                </div>
            </div>
...
@include("operadores.upload_phone_whatsapp.mdlUpload")
@include("operadores.upload_phone_whatsapp.mdlDetail")
@endsection
