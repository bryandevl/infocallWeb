...
Exportar TXT Promesas FALABELLA
@endsection
...
<div class="container-fluid spark-screen" style="padding: 20px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        downloadBtn.addEventListener("click", function () {
            ...
            fetch("http://192.168.1.6:3000/reportesvicidial/promesabfb", {
                method: "POST",
                headers: {
    ...
    .then(function (zipContent) {
        ...
        if (txtFile) {
            txtFile.async("string").then(function (content) {
                ...
                const fileName = `C_600_FALABELLA_${fileDate}.txt`;  // Nombre del archivo con la fecha
