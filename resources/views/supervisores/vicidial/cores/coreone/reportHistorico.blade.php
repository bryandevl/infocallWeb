...
REPORTE HISTORICO DE GESTINONES
@endsection
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    downloadBtn.addEventListener("click", function () {
        ...
        fetch("http://192.168.1.6:3000/reportesvicidial/reportHistorico", {  // Cambiar la URL aquí
            method: "POST",
            headers: {
        ...
        .then(blob => {
            ...
            zip.loadAsync(blob)
                .then(function (zipContent) {
                    ...
                    const excelFile = zipContent.file("reporte_historico.xlsx");  // Verifica que el nombre sea correcto
                    if (excelFile) {
                        excelFile.async("blob").then(function (content) {
                            ...
                            const fileName = `EXPORT_LEAD_REPORT_${fileDate}.xlsx`;  // Nombre del archivo con la fecha
