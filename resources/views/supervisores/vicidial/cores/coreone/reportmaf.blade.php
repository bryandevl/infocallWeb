...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Evento de clic para descargar el archivo ZIP
    downloadBtn.addEventListener("click", function () {
        ...
        fetch("http://192.168.1.6:3000/reportesvicidial/reportmaf", {
            method: "POST",
            headers: {
        ...
        .then(blob => {
            ...
            zip.loadAsync(blob)
                .then(function (zipContent) {
                    ...
                    // Asegurarse de que el archivo se llama correctamente
                    const excelFile = zipContent.file("report.xlsx"); // Verifica que el nombre sea correcto
                    if (excelFile) {
                        // Descomprimir el archivo Excel
                        excelFile.async("blob").then(function (content) {
                            ...
                            const fileName = `GESTIONES_CRCOBRANZAS_${fileDate}.xlsx`;  // Nombre del archivo con la fecha

                            // Crear un enlace para descargar el archivo Excel extraído
                        ...
                        alert("El archivo Excel no se encontró dentro del ZIP.");
                    }
                })
                .catch(function (err) {
