        ...
        $(document).ready(function (e) {
            ...
            let table = $("#tDatos").dataTable({
                ...
                ajax: {
                    ...
                    url: "{{ route('supervisores_cruces_dni_store') }}",
                    dataType: "json",
                    data: {data: '{{ $data }}'},
                    type: 'POST',
                    cache: true
                ...
                drawCallback: function (settings) {
                    ...
                    api.column(groupColumn, {page: 'current'}).data().each(function (group, i) {
                        if (last !== group) {
                            $(rows).eq(i).before(
                                '<tr class="group"><td class="details-control" colspan="2"><span class="fa fa-user" ></span> DNI: <a href="#" data-target="#modal-essalud" data-toggle="modal" data-dni="' + rowsData[i].dni + '" >' + group + '</a> - ' + rowsData[i].nombre + '</td></tr>'
                            );
            ...
            <div class="col-md-9 col-md-offset-1">
                ...
                <div class="box box-success box-solid">
                    ...
                    <div class="box-footer">
                        <a class="btn btn-default btn-flat" href="{{ route('supervisores_cruces_dni_create') }}"><i
