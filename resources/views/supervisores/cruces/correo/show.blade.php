...
@section('contentheader_title')
    <i class="fa fa-heartbeat"></i> Correo
@endsection
...
@section('jquery')
    <script type="text/javascript">
        $('#men-super, #men-super-cor').addClass('active');
    </script>
    <script type="text/javascript">
        $(document).ready(function (e) {
            $("#tDatos").dataTable({
                ...
                ajax: {
                    ...
                    url: "{{ route('supervisores_cruces_correo_store') }}",
                    dataType: "json",
                    data: { data: '{{ $data }}' },
                    type: 'POST',
                    cache: false
...
<!--                                <th>Empresa</th>
                    ...
                    <div class="box-footer">
                        <a class="btn btn-default btn-flat" href="{{ route('supervisores_cruces_correo_create') }}"><i
    ...
    <div id="modal-correo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-correo">
