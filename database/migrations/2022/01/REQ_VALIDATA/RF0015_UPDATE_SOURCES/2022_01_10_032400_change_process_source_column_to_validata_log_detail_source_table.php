...
class ChangeProcessSourceColumnToValidataLogDetailSourceTable extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE validata_log_detail_source MODIFY process_source ENUM('RENIEC','RENIEC_HERMANOS','RENIEC_FAMILIARES','RENIEC_CONYUGES','CORREOS','MOVISTAR','MOVISTAR_FIJO','CLARO','ENTEL','BITEL','ESSALUD', 'EMPRESAS_DOCUMENTO', 'OTHER') DEFAULT 'OTHER' NOT NULL");
    }
}
