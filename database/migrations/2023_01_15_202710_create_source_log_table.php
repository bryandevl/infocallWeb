...
class CreateSourceLogTable extends Migration {
	...
	public function up()
	{
		Schema::create('source_log', function(Blueprint $table)
		{
			$table->bigInteger('id', true);
			$table->string('code', 50)->unique('IDX_documento');
