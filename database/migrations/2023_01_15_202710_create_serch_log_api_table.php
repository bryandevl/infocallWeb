...
class CreateSerchLogApiTable extends Migration {
	...
	public function up()
	{
		Schema::create('serch_log_api', function(Blueprint $table)
		{
			$table->bigInteger('id', true);
			$table->bigInteger('serch_log_id')->nullable();
			$table->enum('api', array('INFO','CORREO','SBS','TELEFONO','ESSALUD','FAMILIAR'))->nullable();
			$table->dateTime('time_start')->nullable();
			$table->dateTime('time_end')->nullable();
			$table->bigInteger('requests_total')->nullable()->default(0);
			$table->bigInteger('content_total')->nullable()->default(0);
			$table->timestamps(10);
			$table->softDeletes();
