...
CREATE TABLE `persona` (
  ...
  `ubigeo_direccion` varchar(300) DEFAULT NULL,
...
CREATE TABLE `persona_familiar` (
  ...
  `persona_id` bigint(20) DEFAULT NULL,
  `documento` varchar(20) NOT NULL,
  `documento_familiar` varchar(20) NOT NULL,
  `ape_paterno` varchar(100) DEFAULT NULL,
  `ape_materno` varchar(100) DEFAULT NULL,
  `nombres` varchar(100) DEFAULT NULL,
  `fec_nacimiento` date DEFAULT NULL,
  `tipo` enum('HERMANO','CONYUGE','OTRO') DEFAULT NULL,
  `fec_cron` datetime DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `persona_telefono` (
  ...
  `tipo_operadora` enum('MOVISTAR','CLARO','ENTEL','BITEL','OTRO') DEFAULT NULL,
  `origen_data` varchar(100) DEFAULT NULL,
